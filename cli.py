...
class Interface():
    ...
    def __init__(self):
        ...
        self.parser = argparse.ArgumentParser(formatter_class=raw, description="SPH.py is the user interface for our physics simulation program.\n"
                                "'SPH' stands for Smoothed Particle Hydrodynamics, which is an algorithm for simulating fluid flows.\n"
